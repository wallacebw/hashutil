...
def chunk_file(file_name: str, segments: int = 1) -> list:
    ...
    with open(file_name, 'r', encoding="utf", errors="surrogateescape") as file:
...
chunk_list = chunk_file("/mnt/nfs/nas/Applications/Security/hashcat/dict/unprocessed/pwned_20230922.dict", 3)
print(*chunk_list, sep="\n")
